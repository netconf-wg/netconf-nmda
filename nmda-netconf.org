...
The "origin-filter" parameter can be used to select nodes matching any
of a set of given "origin" values, and the "negated-origin-filter"
parameter can be used to select nodes that do not match a set of given
"origin" values.
